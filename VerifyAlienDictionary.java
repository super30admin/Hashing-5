...
public class VerifyAlienDictionary { 
	...
	public static void main (String[] args) {	
		VerifyAlienDictionary ob  = new VerifyAlienDictionary();	
		String[] words = {"word","world","row"}; //{"hello","leetcode"};
		String order = "worldabcefghijkmnpqstuvxyz";//"hlabcdefgijkmnopqrstuvwxyz";
		
		System.out.println("Is alien words sorted lexicographically: "+ ob.isAlienSorted(words, order));         
	}	
}
